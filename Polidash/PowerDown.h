...
PowerDown::PowerDown() : Figura(900, rand() % (500 - 50 + 1) + 500, 100, 100, rand() % (4 - 1 + 1) + 4, rand() % (10 - 3 + 1) + 10, color)
{
	this->color = color;
...
void PowerDown::dibujar(Graphics^ canvas)
{
...
void PowerDown::borrar(Graphics^ canvas)
{
	Font^ fuente = gcnew Font("Arial", 12);
	Pen^ lapiz = gcnew Pen(Color::WhiteSmoke);
